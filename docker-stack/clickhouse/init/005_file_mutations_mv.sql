...
-- first write). Run manually or via /init-claude-analytics skill:
--
...
-- ============================================================
CREATE MATERIALIZED VIEW IF NOT EXISTS claude_analytics.file_mutations_edit_mv
TO claude_analytics.file_mutations
AS
WITH
...
-- ============================================================
CREATE MATERIALIZED VIEW IF NOT EXISTS claude_analytics.file_mutations_write_mv
TO claude_analytics.file_mutations
AS
WITH
...
-- ============================================================
CREATE MATERIALIZED VIEW IF NOT EXISTS claude_analytics.file_mutations_delete_mv
TO claude_analytics.file_mutations
AS
WITH
...
-- ============================================================
CREATE MATERIALIZED VIEW IF NOT EXISTS claude_analytics.file_mutations_changed_mv
TO claude_analytics.file_mutations
AS
WITH
