...
CREATE MATERIALIZED VIEW IF NOT EXISTS claudalytics.websites_visited_fetch_mv
TO claudalytics.websites_visited
AS
WITH
...
CREATE MATERIALIZED VIEW IF NOT EXISTS claudalytics.websites_visited_search_mv
TO claudalytics.websites_visited
AS
WITH
...
CREATE MATERIALIZED VIEW IF NOT EXISTS claudalytics.websites_visited_bash_mv
TO claudalytics.websites_visited
AS
WITH
