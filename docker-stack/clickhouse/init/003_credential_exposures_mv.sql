...
-- Run this manually or via the /init-claudalytics skill:
--
...
CREATE MATERIALIZED VIEW IF NOT EXISTS claudalytics.credential_exposures_mv
TO claudalytics.credential_exposures
AS
WITH
