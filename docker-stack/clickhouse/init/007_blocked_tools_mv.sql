...
CREATE MATERIALIZED VIEW IF NOT EXISTS claude_analytics.blocked_tools_pre_mv
TO claude_analytics.blocked_tools
AS
SELECT
...
CREATE MATERIALIZED VIEW IF NOT EXISTS claude_analytics.blocked_tools_post_mv
TO claude_analytics.blocked_tools
AS
SELECT
    Timestamp AS timestamp,
