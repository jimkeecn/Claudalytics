...
CREATE MATERIALIZED VIEW IF NOT EXISTS claude_analytics.compaction_events_pre_mv
TO claude_analytics.compaction_events
AS
SELECT
...
CREATE MATERIALIZED VIEW IF NOT EXISTS claude_analytics.compaction_events_post_mv
TO claude_analytics.compaction_events
AS
SELECT
    Timestamp AS timestamp,
